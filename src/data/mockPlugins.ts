import type { PluginCollection } from '@/types/Plugins'
...
export const mockPlugins: PluginCollection = {
  'mock-plugin-search': {
    ...
    author: 'Dev Tester',
    description:
      'A highly efficient plugin to test the search bar functionality and responsiveness.',
  ...
  'mock-plugin-auth': {
    ...
    author: 'Test User',
    description:
      'Provides fake authentication tokens for local development without connecting to the backend.',
