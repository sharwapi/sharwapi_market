...
import type { PluginCollection, PluginEntity } from '@/types/Plugin';
...
export const usePluginStore = defineStore('plugin', () => {
  ...
  const fetchPlugins = async () => {
    ...
    if (IS_TEST_MODE) {
        ...
        try {
        const response = await fetch('https://raw.githubusercontent.com/sharwapi/sharwapi_Plugins_Collection/main/plugins.json');
